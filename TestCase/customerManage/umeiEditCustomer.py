...
class umeiEditCustomer(unittest.TestCase):
    def __init__(self,methodName):
        unittest.TestCase.__init__(self,methodName)
        print "***************EditCustomer test************************"
    ...
    def test_editCustomer(self):
        ...
        try:
            ...
            btn_edit = self.driver.find_element_by_id("com.staff:id/tv_right")
            btn_edit.click()
            #头像
            ...
            #确认修改
            btn_update_save = self.driver.find_element_by_id("com.staff:id/btn_save")
            btn_update_save.click()
            sleep(3)
...
def suite(self):
    ...
    suite.addTest(umeiEditCustomer("test_editCustomer"))
